...
/// <summary>
/// A real <see cref="Button"/> (Command, Click, focus, accessibility) rendered as liquid glass, with
/// spring press feedback. Tuned defaults keep it light; tweak the exposed knobs for tint / blur.
/// </summary>
public class GlassButton : Button, IGlassVisual
{
    public static readonly StyledProperty<double> BlurRadiusProperty =
        AvaloniaProperty.Register<GlassButton, double>(nameof(BlurRadius), 8.0);

    public static readonly StyledProperty<double> VibrancyProperty =
        AvaloniaProperty.Register<GlassButton, double>(nameof(Vibrancy), 1.4);

    public static readonly StyledProperty<bool> ChromaticAberrationProperty =
        AvaloniaProperty.Register<GlassButton, bool>(nameof(ChromaticAberration), false);

    public static readonly StyledProperty<Color> TintColorProperty =
        AvaloniaProperty.Register<GlassButton, Color>(nameof(TintColor), Colors.Transparent);

    public static readonly StyledProperty<Color> SurfaceColorProperty =
        AvaloniaProperty.Register<GlassButton, Color>(nameof(SurfaceColor), Color.FromArgb(28, 255, 255, 255));

    public static readonly StyledProperty<bool> ShadowEnabledProperty =
        AvaloniaProperty.Register<GlassButton, bool>(nameof(ShadowEnabled), true);

    public static readonly StyledProperty<bool> InteractiveHighlightEnabledProperty =
        AvaloniaProperty.Register<GlassButton, bool>(nameof(InteractiveHighlightEnabled), true);

    public static readonly StyledProperty<double> InteractiveMaxScaleDipProperty =
        AvaloniaProperty.Register<GlassButton, double>(nameof(InteractiveMaxScaleDip), 6.0);

    private readonly GlassPressDriver _driver;

    static GlassButton()
    {
        ClipToBoundsProperty.OverrideDefaultValue<GlassButton>(false);
        CornerRadiusProperty.OverrideDefaultValue<GlassButton>(new CornerRadius(20));
        TemplateProperty.OverrideDefaultValue<GlassButton>(CreateTemplate());

        AffectsRender<GlassButton>(
            CornerRadiusProperty, BlurRadiusProperty, VibrancyProperty, ChromaticAberrationProperty,
            TintColorProperty, SurfaceColorProperty, ShadowEnabledProperty);
    }
    ...
    double IGlassVisual.HighlightOpacity => 0.6;
    ...
    private static FuncControlTemplate CreateTemplate() =>
        new FuncControlTemplate<GlassButton>((_, ns) =>
        {
